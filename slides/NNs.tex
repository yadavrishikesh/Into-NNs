...
\begin{itemize}
\item See the code \href{https://github.com/yadavrishikesh/Into-NNs/tree/main/code}{NNs-for-classification-from-scratch.R} for fitting a two layer Neural Networks from scratch for classification task
\item See the code \href{https://github.com/yadavrishikesh/Into-NNs/tree/main/code}{NNs-for-classification-using-neuralnet-package.R} for fitting a two layer Neural Networks using the \texttt{neuralnet} R-package
\end{itemize}
\textbf{Exercise}
\begin{itemize}
\item Compare the two results that you got from the one coded from scratch and one using the \texttt{neuralnet} R-package
\item Try changing the number of neurons (M) in hidden layers. How does this affect the accuracy in test and train data sets. Do you see some sort of overfitting as increasing M?
\item Try changing the activation functions to linear which results in Linear regression. How accurate results you got?
\item Try changing the learning rate parameter. What did you notice in the learning loss function? 
\end{itemize}
\end{frame}


\begin{frame}{Further Topics in Neural Networks} 
\begin{itemize}
\item Deep learning
\end{itemize}
\end{frame}
...
\begin{frame}{Some Resources to Fit a Neural Networks and Deep Neural Networks in R}
\begin{itemize}
\item
\end{itemize}
\end{frame}
